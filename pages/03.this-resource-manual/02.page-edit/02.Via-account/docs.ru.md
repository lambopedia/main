...
| Шаблон | Тип | Описание |
| -------------- | -------------- | --------------- |
| Default | Контент | Базовый шаблон страницы GRAV. Вместо него стоит использовать шаблон "Docs". |
...
| Search | Техническая | Используется в механизме поиска по сайту. Базовый механизм поиска. |
| Simplesearch result | Техническая | Используется в механизме поиска по сайту. Механизм поиска "Simplesaerch" |
