...
Уровень надёжности = 2^(2 + значение_уровня_надёжности_в_адресе).  
ИД носителя 64-битный, но в адресе составляет 60 бит. Например уровень надёжности в адресе = 0, тогда уровень надёжности, согласно формуле = 4 или степень двойки = 2. Если в адресе указан ИД носителя = 4 (..00100), то это означает все идентификаторы от 4-ки до 7-ки (4, 5, 6, 7).  
